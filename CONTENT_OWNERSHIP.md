...
- **Deployments:** Siriraj, Khian Sa, and MU Health Data Network implementation-specific facts.
...
## Durable ownership wording

Use this model whenever ownership, custody, or the role of HealthTAG needs to be stated:
...
- HealthTAG provides trust and interoperability infrastructure for authorized exchange.

The vision tagline, "Your data. Your consent. One connected Thailand." and "ข้อมูลของคุณ ความยินยอมของคุณ เชื่อมถึงกันทั้งประเทศ", belongs canonically to Company. Other pages may use it briefly and link back to Company. Present it as the future HealthTAG is working toward, not as current nationwide coverage.
