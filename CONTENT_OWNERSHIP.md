...
- **Interoperability:** HIS ingestion options, HAPI FHIR Server, HL7 FHIR R4, PostgreSQL, Kong, Transformer resource scope.
- **How It Works:** the end-to-end six-step flow at conceptual level.
- **Trust & Access:** hospital data custody, 15-minute authorization window, blockchain audit role and security boundaries.
- **PHR:** patient-facing value, PromptCare ID, multi-provider view.
