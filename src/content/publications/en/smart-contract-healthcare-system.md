...
summary: "Smart contracts execute code-based rules. HealthTAG uses them for authorization and access history."
author: HealthTAG
locale: en
...
Healthcare discussions often propose smart contracts for consent, payments, medicine supply chains, and research. HealthTAG currently uses them for authorization and access history.
