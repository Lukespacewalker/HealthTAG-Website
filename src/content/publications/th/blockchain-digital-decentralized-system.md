...
sources:
  - label: "โพสต์ต้นฉบับวันที่ 18 พฤศจิกายน 2568"
    ...
    type: first-party
  - label: "บทความในคลัง CMS ของ HealthTAG (วันที่ 26 พฤษภาคม 2569 เป็นวันที่ย้ายข้อมูล ไม่ใช่วันที่เผยแพร่ต้นฉบับ)"
...
ผู้ป่วยคนเดียวกันอาจมีรหัสประจำตัวต่างกันในแต่ละโรงพยาบาล HealthTAG ใช้ PromptCare ID เชื่อมรหัสเหล่านั้นเข้ากับบุคคลเดียวกัน โดยข้อมูลการเชื่อมโยงเก็บใน Amazon DynamoDB งานส่วนนี้ช่วยระบุตัวบุคคลระหว่างผู้ให้บริการ แต่ไม่ได้ย้ายเวชระเบียนออกจากโรงพยาบาล
...
โครงสร้างแบบ hash-linked ช่วยให้ตรวจพบการแก้ไขประวัติได้ยากขึ้น แต่ความปลอดภัยของระบบสุขภาพยังขึ้นอยู่กับหลายส่วน Kong API Gateway ทำหน้าที่เป็นขอบเขต TLS และการยืนยันตัวตน ส่วนการจัดการข้อมูลรับรอง การตั้งค่า firewall การเข้ารหัสข้อมูล และขั้นตอนปฏิบัติงานยังต้องได้รับการดูแลโดยระบบและหน่วยงานที่รับผิดชอบ
...
สำหรับ HealthTAG ขอบเขตที่ยืนยันได้คือ Hospital API ตรวจช่วงเวลา 15 นาทีจากสถานะบน blockchain และ blockchain เก็บเหตุการณ์การให้ความยินยอมกับการเข้าถึง รายละเอียดการเรียกใช้ smart contract ควรอ้างอิงเอกสารของระบบรุ่นที่ใช้งานจริง ไม่ควรสรุปจากแนวคิดทั่วไปของ blockchain
...
> หมายเหตุการย้ายข้อมูล: CMS แสดงวันที่ 26 พฤษภาคม 2569 ซึ่งตรงกับรอบย้ายข้อมูลเดิม โพสต์ของ HealthTAG ยืนยันว่าบทความต้นฉบับเผยแพร่วันที่ 18 พฤศจิกายน 2568 จึงใช้วันที่จากโพสต์แทนวันที่ย้าย CMS
