...
| [`docs/NETWORK_ASSETS.md`](./docs/NETWORK_ASSETS.md) | Provenance and checksums for partner marks downloaded from official organization websites |
...
- **MU Health Data Network:** HealthTAG is the technology partner for MU Health Data Network and MU Health Wallet. Five Mahidol University institutions are live in 2026 with 60,000 active personnel and student users.
